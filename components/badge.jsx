...
const colors = {
  ...
  blue: 'bg-blue-500/15 text-blue-700 group-data-hover:bg-blue-50 dark:hover:bg-gray-7000/25 dark:text-blue-400 dark:group-data-hover:bg-blue-50 dark:hover:bg-gray-7000/25',
  indigo:
